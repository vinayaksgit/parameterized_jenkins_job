        ...
        stage('List AWS Resources') {
            steps {
                script {
                    ...
                    withCredentials([usernamePassword(credentialsId: '2dbdd907-18e5-42cf-b2a4-afa9267d4a8e', usernameVariable: 'AWS_ACCESS_KEY_ID', passwordVariable: 'AWS_SECRET_ACCESS_KEY')]) {
