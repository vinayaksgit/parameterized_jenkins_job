        ...
        stage('List AWS Resources') {
            steps {
                script {
                    ...
                    withCredentials([usernamePassword(credentialsId: '5119e101-40be-4cfd-a018-af36cf7788e6', usernameVariable: 'AWS_ACCESS_KEY_ID', passwordVariable: 'AWS_SECRET_ACCESS_KEY')]) {
